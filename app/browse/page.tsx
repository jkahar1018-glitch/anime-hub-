        ...
        <div className="relative mx-auto max-w-7xl px-4 pb-8 pt-10 sm:px-6 sm:pb-10 sm:pt-14 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-white/45 sm:text-base">
              Explore thousands of anime from the
              AnimeHub library. Find your next favorite
              series by genre, rating, and popularity.
            </p>
          </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.025] px-6 py-20 text-center">
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-2 max-w-md text-sm leading-6 text-white/40">
                We couldn't find any anime for this
                selection. Try another genre or browse
                the complete library.
              </p>

              <Link
                href="/browse"
                className="mt-7 inline-flex items-center rounded-xl bg-orange-500 px-6 py-3 text-sm font-black text-black shadow-lg shadow-orange-500/20 transition hover:bg-orange-400 hover:-translate-y-0.5"
              >
                Browse All Anime
              </Link>
            </div>
